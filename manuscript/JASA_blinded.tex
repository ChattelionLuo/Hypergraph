...
\if0\anon
{
  ...
  \bigskip
  \begin{center}
    {\LARGE\bf Deep Ranking with Heterogeneous Effects}
\end{center}
  \medskip
} \fi
...
= \prod_{j \in e}\rho_{\mathcal{X}}(X_{e,j})$. Assumption (2.2) is a standard continuity assumption on the nonparametric component. Assumption (2.3) centres the covariate effects, modulo common shifts in $f$. Under these conditions, we establish the following identifiability result.
\begin{theorem}
\label{lemma_ident}
